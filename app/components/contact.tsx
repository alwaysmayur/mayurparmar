    ...
    <div className="container" id="contact">
      <div className=" flex justify-start w-full ">
        ...
        <div className="py-14 px-5 flex  h-full  justify-center content-center items-center flex-col w-full">
          <div className=" justify-center content-center items-center flex  text-xl ">
            <span className="font-code font-thin text-textBlue">03.</span>
            <h2 className="mx-3  font-code text-textBlue ">What’s Next?</h2>
          </div>
          <h1 className="font-semibold my-5 text-headGray font-noto text-4xl md:text-6xl">
            Get In Touch
          </h1>
          <span className="text-textGray text-center max-w-xl text-md">
